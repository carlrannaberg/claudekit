...
async function main() {
  ...
  try {
    ...
    if (projectInfo.hasTypeScript) console.log(`  ${chalk.green('✓')} TypeScript`);
    if (projectInfo.hasESLint) console.log(`  ${chalk.green('✓')} ESLint`);
    if (projectInfo.hasPrettier) console.log(`  ${chalk.green('✓')} Prettier`);
    if (projectInfo.hasJest) console.log(`  ${chalk.green('✓')} Jest`);
    if (projectInfo.hasVitest) console.log(`  ${chalk.green('✓')} Vitest`);
    if (projectInfo.isGitRepository) console.log(`  ${chalk.green('✓')} Git Repository`);
