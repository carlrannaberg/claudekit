...
echo "  - /agent-symlink           - Convert CLAUDE.md to AGENT.md standard"
echo -e "\nHooks installed:"
...
echo -e "\nDocumentation:"
echo "  - .claude/checkpoint-system.md   - Checkpoint system details"
echo "  - .claude/hooks-documentation.md - Hooks documentation"
