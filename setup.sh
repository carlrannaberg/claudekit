...
echo "  - /spec:decompose [file]     - Decompose spec into manageable tasks"
...
echo "  Install globally using your package manager:"
echo "    npm:  npm install -g @upstash/context7-mcp"
echo "    yarn: yarn global add @upstash/context7-mcp"
echo "    pnpm: pnpm add -g @upstash/context7-mcp"
echo "  Then: claude mcp add context7 context7-mcp"
echo "  Check connection with /mcp command"