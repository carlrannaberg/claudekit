    ...
    it('should correctly group messages as they appear in Claude Code UI', () => {
      ...
      const mockTranscript = [
        ...
        JSON.stringify({
          ...
          message: {
            content: [
              { type: 'tool_use', name: 'Edit', input: { file_path: '/tests/unit/transcript-parser.test.ts' } }
            ]
          }
        }),
        ...
        JSON.stringify({
          ...
          message: {
            content: [
              { type: 'text', text: "Now let's run the tests again:" }
            ]
          }
        }),
        JSON.stringify({
        ...
        JSON.stringify({
          ...
          message: {
            content: [
              { type: 'text', text: "Great! Now let's run the full test suite to ensure everything still works:" }
            ]
          }
        }),
        JSON.stringify({
        ...
        JSON.stringify({
          ...
          message: {
            content: [
              { type: 'text', text: "Excellent! Let's also verify the self-review tests still pass:" }
            ]
          }
        }),
        JSON.stringify({
        ...
        JSON.stringify({
          ...
          message: {
            content: [
              { type: 'text', text: '## Code Review Summary\n\n### ✅ **Tests Added**' }
            ]
          }
        }),
      ].join('\n');
